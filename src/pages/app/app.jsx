...
import { BlockIfAuthFalse, BlockIfAuthFalseResetPassword, BlockIfAuthTrue, ProtectedRouteElement } from "../../components/protected-route-element/protected-route-element";
    ...
    <div className={styles.App}>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/reset-password" element={<ProtectedRouteElement element={<ResetPassword/>} block={BlockIfAuthFalseResetPassword}/>}/>
